...
const TOPICS = ["All", "Contracts", "Marketing", "Warranties", "Business Planning", "Technology"];

const ToeicVocabScreen = () => {
  const [selectedTopic, setSelectedTopic] = useState("All");
  const { speak } = useSpeech();

  const filteredData = useMemo(() => {
    const data = toeicData as IToeicWord[]; 
...
export default ToeicVocabScreen;